...
import BkKasPembantuForm from "./BkKasPembantuForm"
...
import BkKasPembantuFilter from "./BkKasPembantuFilter"
...
export default function BkKasPembantuPage() {
  /** DATA RESP */
  ...
  return (
    <>
      <TableDataListAction
        ...
        path={API_PATH().downloadBuku.administrasi.bukuKasPembantu}>
        <BkKasPembantuFilter />
      </TableDataListAction>
      ...
      <ModalForm modalProps={modal} onHide={handleCloseModal}>
        <BkKasPembantuForm onCancel={handleCloseModal}></BkKasPembantuForm>
      </ModalForm>
      ...
      <ModalImport
        ...
        path={`${API_PATH().import.administrasi.bukuKasPembantu}`}
        templatePath={IMPORT_FILE_FORMAT().administrasi.bukuKasPembantu}
      />
    </>
  )
}
