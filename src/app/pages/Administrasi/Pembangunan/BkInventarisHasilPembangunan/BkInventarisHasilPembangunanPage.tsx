...
import { BK_INVENTARIS_HASIL_PEMBANGUNAN_COLUMNS } from "@app/config/react-table/administrasi/bk-inventaris-hasil-pembangunan.config"
import BkInventarisHasilPembangunanForm from "./BkInventarisHasilPembangunanForm"
import { IBukuInventarisHasilHasilPembangunan } from "@app/interface/administrasi/buku-inventaris-hasil-pembangunan.interface"
...
export default function BkRencanaKerjaPembangunanPage() {
  ...
  const [columns] = useState<any>(BK_INVENTARIS_HASIL_PEMBANGUNAN_COLUMNS())
  ...
  const handleRespDataApi = (data: any) => {
    ...
    data?.forEach((item: IBukuInventarisHasilHasilPembangunan) => {
      ...
      dataTableValue.push({
        ...
        biaya: numberCurrencyID(item?.biaya) || "0",
  ...
  return (
    <>
      <TableDataListAction
        ...
        path={
          API_PATH().downloadBuku.administrasi
      ...
      <ModalForm modalProps={modal} onHide={handleCloseModal}>
        <BkInventarisHasilPembangunanForm
          onCancel={handleCloseModal}></BkInventarisHasilPembangunanForm>
      </ModalForm>
      ...
      <ModalImport
        ...
        path={`${API_PATH().import.administrasi.bukuInventarisHasilHasilPembangunan}`}
        templatePath={
          IMPORT_FILE_FORMAT().administrasi.bukuInventarisHasilPembangunan
        }
      />
    </>
  )
