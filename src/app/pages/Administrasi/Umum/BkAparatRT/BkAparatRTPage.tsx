...
import BkAparatPemerintahFilter from "../BkAparatPemerintah/BkAparatPemerintahFilter"
import BkAparatRTForm from "./BkAparatRTForm"

export default function BkAparatRTPage() {
  /** DATA RESP */
  ...
  return (
    <>
      ...
      <ModalForm modalProps={modal} onHide={handleCloseModal}>
        <BkAparatRTForm
          onCancel={handleCloseModal}></BkAparatRTForm>
      </ModalForm>
