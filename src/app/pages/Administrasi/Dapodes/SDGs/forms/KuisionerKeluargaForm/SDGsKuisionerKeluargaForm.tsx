...
const initialData = SDGsKuisionerKeluragaField

export function SDGKuesionerKeluarga({
  defaultValues = null,
  afterSubmit = null,
}: any) {
  const methods = useForm<ISDGSKuisionerKeluargaDetail>()
  ...
  const handleSubmitForm = async (e: any) => {
    ...
    const path = id
      ? `${API_PATH().sdgs}/update-keluarga`
      : `${API_PATH().sdgs}/add-keluarga`
