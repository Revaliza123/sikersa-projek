...
import {
  ISDGSKuesioner,
  ISDGSKuesionerRukunTetanggaDetail,
  SDGSKuesionerRukunTetanggaField,
...
const initialData = SDGSKuesionerRukunTetanggaField

export function SDGKuesionerRukunTetangga({ afterSubmit = null }: any) {
  ...
  const handleSubmitForm = async (e: any) => {
    ...
    const path = id
      ? `${API_PATH().sdgs}/update-rt`
      : `${API_PATH().sdgs}/add-rt`
    let params: ISDGSKuesioner<ISDGSKuesionerRukunTetanggaDetail>
