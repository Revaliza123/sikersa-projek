...
export default function ExportIcon() {
  return (
    <svg
      ...
      <g clipPath="url(#clip0_273_107)">
        <path
          d="M13.3332 13.3333L9.99984 10L6.6665 13.3333"
          stroke="currentColor"
          strokeWidth="2"
          strokeLinecap="round"
