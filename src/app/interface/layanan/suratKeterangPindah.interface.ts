...
export interface ISuratKeterangPindahAnggotaKeluarga {
  nik: string
  nama_lengkap: string
...
export interface ISuratKeterangPindah {
  daerah_asal: {
    nomor_surat: string
    nomor_kk: string
  ...
  pengikut: ISuratKeterangPindahAnggotaKeluarga[]
  status: string
}

export const SuratKeterangPindahFields: ISuratKeterangPindah = {
  daerah_asal: {
    nomor_surat: "",
    nomor_kk: "",
