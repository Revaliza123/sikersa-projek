...
export interface IFormulirPindahKeluarPengikut {
  nik: string
  nama_lengkap: string
...
export interface IFormulirPindahKeluar {
  _id: string
  daerah_asal: {
    nomor_surat: string
    nomor_kk: string
  ...
  pengikut: IFormulirPindahKeluarPengikut[]
  status: string
}

export const FormulirPindahKeluarFields: IFormulirPindahKeluar = {
  _id: "pk",
  daerah_asal: {
    nomor_surat: "",
    nomor_kk: "",
